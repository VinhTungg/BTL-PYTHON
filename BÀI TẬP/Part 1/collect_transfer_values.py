...
# Sử dụng absolute path để tránh lỗi khi chạy từ directory khác
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
DB_FILE = os.path.join(SCRIPT_DIR, "fbref_pl_2024_2025_full.sqlite")
...
def crawl_page(url):
    try:
        ...
        date_candidates = soup.find_all(string=re.compile("Last update", re.IGNORECASE))
        last_update = "N/a"
